...
<body>
					...
					<div class="row">
						<div class="col-md-4 stretch-card grid-margin">
							<div class="card bg-gradient-danger card-img-holder text-white">
								<div class="card-body">
									<img
										src="${pageContext.request.contextPath}/resources/admin/images/dashboard/circle.svg"
									...
									<div class="table-responsive">
										<table class="table">
											...
											<tbody>
												...
												<tr>
													<td><img
														src="${pageContext.request.contextPath}/resources/admin/images/faces/face2.jpg"
												...
												<tr>
													<td><img
														src="${pageContext.request.contextPath}/resources/admin/images/faces/face3.jpg"
												...
												<tr>
													<td><img
														src="${pageContext.request.contextPath}/resources/admin/images/faces/face4.jpg"
								...
								<div class="card-body">
									...
									<div class="row mt-3">
										<div class="col-6 pr-1">
											<img
												src="${pageContext.request.contextPath}/resources/admin/images/dashboard/img_1.jpg"
												class="mb-2 mw-100 w-100 rounded" alt="image"> <img
												src="${pageContext.request.contextPath}/resources/admin/images/dashboard/img_4.jpg"
												class="mw-100 w-100 rounded" alt="image">
										</div>
										<div class="col-6 pl-1">
											<img
												src="${pageContext.request.contextPath}/resources/admin/images/dashboard/img_2.jpg"
												class="mb-2 mw-100 w-100 rounded" alt="image"> <img
												src="${pageContext.request.contextPath}/resources/admin/images/dashboard/img_3.jpg"
												class="mw-100 w-100 rounded" alt="image">
										</div>
									</div>
	...
	<!-- plugins:js -->
	<script
		src="${pageContext.request.contextPath}/resources/admin/vendors/js/vendor.bundle.base.js"></script>
	<!-- endinject -->
	<!-- Plugin js for this page -->
	<script
		src="${pageContext.request.contextPath}/resources/admin/vendors/chart.js/Chart.min.js"></script>
	<!-- End plugin js for this page -->
	<!-- inject:js -->
	<script
		src="${pageContext.request.contextPath}/resources/admin/js/off-canvas.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/admin/js/hoverable-collapse.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/admin/js/misc.js"></script>
	<!-- endinject -->
	<!-- Custom js for this page -->
	<script
		src="${pageContext.request.contextPath}/resources/admin/js/dashboard.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/admin/js/todolist.js"></script>
