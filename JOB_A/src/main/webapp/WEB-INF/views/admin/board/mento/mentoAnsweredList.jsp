		...
		<main role="main" class="main-content">
			<div class="container-fluid">
				<div class="row justify-content-center">
					<div class="col-12">
						<h2 class="page-title">MENTO ANSWERED LIST</h2>
						<br />
						
						<!-- 탭 -->
						<div class="tab-div">
							<div class="tab"><p id="total" class="btn mb-2 btn-outline-primary">전체</p></div>
							<div class="tab"><p id="answered" class="btn mb-2 btn-primary">답변완료</p></div>
								...
								<div class="card shadow">
									<div class="card-body">
										...
										<table class="table table-hover"
											...
											<tbody>
												<c:forEach items="${mentoAnsweredList }" var="mento">
