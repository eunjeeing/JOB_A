														...
														<td>
																<c:if test="${accept.board_Status eq 'Y' }">
																	<button class="btn mb-2 btn-light" style="margin-bottom:0 !important;"
																		onclick="location.href='${pageContext.request.contextPath}/admin/updateStatusB.do?board_No=${accept.board_No}&type_No=${accept.type_No }'">블라인드</button>
																</c:if>
																<c:if test="${accept.board_Status eq 'B' }">
																	<button class="btn mb-2 btn-light" style="margin-bottom:0 !important;"
																		onclick="location.href='${pageContext.request.contextPath}/admin/updateStatusY.do?board_No=${accept.board_No}&type_No=${accept.type_No }'">활성화</button>
																</c:if>
																<c:if test="${accept.board_Status eq 'N'}">
