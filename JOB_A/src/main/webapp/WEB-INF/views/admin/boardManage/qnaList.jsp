															...
															<!-- 체크박스 활성화 조건주기 -->
																<c:if test="${qna.board_Status eq 'Y'}">
																	<input type="checkbox" class="custom-control-input"
																		id="${qna.board_No}" checked>
																	<label class="custom-control-label"
																		for="${qna.board_No}"></label>
 																</c:if>
																<c:if
																	test="${qna.board_Status eq 'B'}">
																	<input type="checkbox" class="custom-control-input"
																		id="${qna.board_No}">
																	<label class="custom-control-label"
																		for="${qna.board_No}"></label>
																...
																<c:if
																	test="${qna.board_Status eq 'N'}">
																	<input type="checkbox" class="custom-control-input"
																		id="${qna.board_No}"  disabled="disabled">
																	<label class="custom-control-label"
																		for="${qna.board_No}"></label>
																</c:if>
															</div>
