...
<body class="is-preload">
										...
										<div class="wrap-info">
											...
											<div class="info_fnc">
												...
												<c:if test="${member.memNo eq co.mem_No}">
													...
													<a href="#" onclick="location.href='${pageContext.request.contextPath}/comments2/deleteComment.do?board_No=${board2.board_No}&comm_No=${co.comm_No }&type_No=${board2.type_No}'">삭제</a>
												</c:if>
											...
											<fmt:formatDate value="${parsedDate}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
												<div class="info_fnc">
													...
													<c:if test="${member.memNo eq co.mem_No}">
														<a href="#" onclick="updateComment(this);return false;">수정</a>
														<a href="#" class="updateConfirm" onclick="updateConfirm(this);" style="display:none;" >수정완료</a>												
														<a href="#" onclick="location.href='${pageContext.request.contextPath}/comments2/deleteComment.do?board_No=${board2.board_No}&type_No=${board2.type_No }&comm_No=${co.comm_No }'">삭제</a>
													</c:if>
	...
	<script>
				...
				.addEventListener(
						...
						function() {
							if (comm_Content.value == ""
								...
								location.href = '${pageContext.request.contextPath}/comments2/insertComment.do?board_No=${board2.board_No}&mem_No=${member.memNo}&type_No=${board2.type_No}&comm_Content='
										+ comm_Content.value;
							}
						}, false);
		...
		function updateConfirm(obj) {
			...
			location.href = "${pageContext.request.contextPath}/comments2/updateComment.do?board_No=${board2.board_No}&type_No=${board2.type_No}&comm_No=" + comm_No + "&comm_Content="
				+ content;
		}
