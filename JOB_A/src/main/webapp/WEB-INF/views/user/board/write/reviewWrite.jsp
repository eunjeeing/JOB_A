				...
				<div id="main">
					<div class="inner">
						...
						<div id="contentsTbl">
							...
							<div id="radioArea">
								<input type="radio" class="radioBtn" id="radio-free" name="type_no" onchange="changeAction(this);" value="9" /><label for="radio-free">면접후기</label>
								<input type="radio" class="radioBtn" id="radio-anon" name="type_no" onchange="changeAction(this);" value="10" /><label for="radio-anon">합격후기</label>
							</div>
							<hr />
							<table id="inputTbl">
							<input type="hidden" name="mem_no" value="${member.memNo}"/>
								...
								<tbody>
									...
									<tr>
										<td>첨부파일</td>
										<td><input type="file" id="attachBtn" name="upFile" value="사진첨부" required/></td>
									</tr>
								</tbody>
							</table>
							<br />
							<div id="contentsArea">
								<p>
									<textarea type="textarea" id="contentsArea-text" name="board_content" required></textarea>
								</p>
							</div>
						</div>
 			...
 			<script>
				...
				function changeAction(obj) {
					if (obj.checked == true) {
						switch (obj.value) {
							case "9":
								document.forms[0].action = "${pageContext.request.contextPath}/reviewWrite.bo";
								console.log("case 9 선택됨")
								break;
							case "10":
								document.forms[0].action = "${pageContext.request.contextPath}/reviewWrite.bo";
								console.log("case 10 선택됨")
								break;
