						...
						<div role="main" class="contents">
							...
							<div class="article-view-contents">
								<p id="contentArea" class="contents-txt">
									${board2.board_Content }</p>
								<p>
								<c:if test="${member.memNo eq board2.mem_No}">
								<div align="right">
									<button style="font-weight: 300; margin-right:10px;">수정</button>
							...
							<div class="article-comments">
								...
								<c:forEach items="${selectComment }" var="co">
									<div id="${co.comm_No }" class="wrap-comment comment-area">
										...
										<p class="cmt-txt"><textarea id="comm_Con2" readonly="readonly">${co.comm_Content }</textarea></p>
										<div class="wrap-info">
											...
											<div class="info_fnc">
											  		<input type="hidden" class="Ref"  name="Ref" value="${co.comm_Ref}" />
											  		<input type="hidden" class="Level"  name="Level" value="${co.comm_Level}" />
