		...
		<div id="main">
			<div class="inner">
				...
				<section class="container">
					...
					<form action="${pageContext.request.contextPath}/updateNotice.bo"
						method="post" name="" onsubmit="return validate();">
							<div class="acticle-view-head" id="head">
								<div class="title-close" style="display: flex;">
									...
									name="board_title" id="board_Title" value="${notice.board_title }" required>
							</div>
							
							<div class="article-view-contents">
								<textarea class="summernote" name="board_content"
								placeholder="내용" required>${notice.board_content}
								</textarea>
							<br />
