						...
						<div role="main" class="contents">
							<div class="acticle-view-head" id="head">
								...
								<i class="far fa-window-close" id="close-icon" style="font-size: 30px; color: #f56a6a; margin-left:auto; margin-right: 0;"
								   onclick="location.href='${pageContext.request.contextPath}/board2/selectQnAList.do'"></i>
								</div>
							...
							<div class="article-view-contents">
								...
								<div align="right">
									<button style="font-weight: 300; margin-right:10px;"
									 onclick="location.href='${pageContext.request.contextPath}/board2/qnaUpdateForm.do?board_No=${board2.board_No}'">수정</button>
									<button style="font-weight: 300;" onclick="location.href='${pageContext.request.contextPath}/board2/deleteQnA.do?board_No=${board2.board_No}'">삭제</button>
								</div>
								</c:if>
								</p>
							</div>
