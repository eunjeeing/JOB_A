		...
		<div id="main">
			<div class="inner">
				...
				<section class="container">
					...
					<form action="${pageContext.request.contextPath}/acceptUpdate.bo"
						method="post" name="" onsubmit="return validate();" enctype="multipart/form-data">
							<div class="acticle-view-head" id="head">
								<div class="title-close" style="display: flex;">
									<!-- 제목 -->
									<input type="hidden" name="board_no"  value="${accept.board_no}"/>
									<h2>면접후기 수정</h2>
									<i class="far fa-window-close" id="close-icon" style="font-size: 30px; color: #f56a6a; margin-left:auto; margin-right: 0;"
								 	...
								 	<h4>제목</h4>
									<input type="text" name="board_mainTitle" value="${accept.board_mainTitle}" placeholder="회사명" required />
									<input type="text" class="form-control" 
									name="board_title" id="board_Title" value="${accept.board_title }" placeholder="상세제목" required>
									<br />
							</div>
							<br />
