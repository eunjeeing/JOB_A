package com.kh.joba.user.blind.controller;
...
import com.kh.joba.user.blind.model.service.BlindService;
...
public class BlindController {
	...
	public String blindSelectOne(@RequestParam int board_No, Model model) {
